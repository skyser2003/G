...
public class AttackObjectDataRow
{
	...
	public List<double> CreateDeltaPos { get; set; }
    public Vector3 CreateDeltaPos_Vector3 { get { return new Vector3((float)CreateDeltaPos[0], (float)CreateDeltaPos[1], (float)CreateDeltaPos[2]); } }
